...
public class C03_SifreKontrolu {
    ...
    public static int ozelKarakterKontroluYap(String sifre) {
        ...
        // sifre  ozel karakter icermelidir.
        // bunun icin bir tum harfleri kontrol edecek bir for loop olusturmaliyim
        // eger sifrenin karakterler,nden bir tanesini ozelKarakterler Sringi iceriyorsa
    ...
    public static int buyukHarfKonroluYap(String sifre) {
        int bayrak=0;
        // - Sifre kucuk harf icermelidir
