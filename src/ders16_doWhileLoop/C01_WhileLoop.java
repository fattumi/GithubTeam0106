...
public class C01_WhileLoop {
    public static void main(String[] args) {
        ...
        while loop'da 2 problem OLUSABİLİR
        1- once degeri kontrol edip, sonra islem yaptimizdan
           body'de bir kere daha kontrol etmemiz gerekebilir.

        2- yapilan islem sayisindan 1 fazla qhile bitis sarti kontrol edilir

        3- while loop oncesinde degerleri kontrol edecegimiz bir variable olusturuyorsak
           ona yapacagimizatamayi dikkatli yapmamiz gerekir
